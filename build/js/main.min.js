...
var _programsSwiper = require("./modules/programs-swiper");
var _newsSwiper = require("./modules/news-swiper");
...
require("./modules/open-sub-menu");
require("./modules/news-tab-active");
...
var initHeroSwiper = function initHeroSwiper() {
  if (document.querySelector('.hero__swiper')) {
    var sliderHeroImg = document.querySelector('[data-slider="hero-images"]');
    var sliderHeroContent = document.querySelector('[data-slider="hero-content"]');
    var pagination = sliderHeroContent.querySelector('[data-slider="hero-bullets"]');
    var swiperHeroImg = new window.Swiper(sliderHeroImg, {
      slidesPerView: 1,
      loop: true,
      autoplay: {
        delay: 3000
    ...
    var swiperHeroContent = new window.Swiper(sliderHeroContent, {
      slidesPerView: 1,
      loop: true,
      effect: 'fade',
      autoHeight: true,
    ...
    var paginations = document.querySelectorAll('.hero__pagination .hero__pagination-btn');
...
},{"./select/custom-select":26}],13:[function(require,module,exports){
"use strict";
...
var initMap = function initMap() {
  if (document.querySelector('.map')) {
    var map = L.map('map').setView([55.028553, 82.928182], 16);
...
},{"./modals":17}],16:[function(require,module,exports){
"use strict";
...
},{"./focus-lock":14,"./scroll-lock":18}],18:[function(require,module,exports){
"use strict";
...
var newsBtns = document.querySelector('.news-materials__buttons');
var newsBtn = document.querySelectorAll('.news-materials__buttons button');
if (newsBtns) {
  newsBtns.addEventListener('click', function (evt) {
    newsBtn.forEach(function (el) {
      ...
      for (var i = 0; i < newsBtn.length; i++) {
        if (newsBtn[i] === evt.target) {
          if (i === newsBtn.length - 1) {
            ...
            newsBtns.style.marginLeft = "".concat(-(width + i * 8), "px");
          }
        }
...
var headerOutsideClick = function headerOutsideClick(evt) {
...
var menuLink = document.querySelectorAll('.menu-header a');
if (menuLink) {
